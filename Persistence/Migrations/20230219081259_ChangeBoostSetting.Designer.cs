...
namespace Persistence.Migrations
{
    ...
    [Migration("20230219081259_ChangeBoostSetting")]
    partial class ChangeBoostSetting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Accounting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.AccountingType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SignOfDebitSide")
                        .IsRequired()
            ...
            modelBuilder.Entity("Domain.Entities.BoostSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("MinCostPerVisit")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Domain.Entities.Profile", b =>
                {
                    ...
                    b.Property<int?>("ProfileSettingId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Accounting", b =>
                {
                    b.HasOne("Domain.Entities.AccountingType", "AccountingType")
            ...
            modelBuilder.Entity("Domain.Entities.Entry", b =>
                {
                    b.HasOne("Domain.Entities.Accounting", "Credit")
                        .WithMany("Credits")
                        .HasForeignKey("CreditId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Accounting", "Debit")
                        .WithMany("Debits")
            ...
            modelBuilder.Entity("Domain.Entities.ProfileSetting", b =>
                {
                    b.HasOne("Domain.Entities.Profile", "Profile")
                        ...
                        .HasForeignKey("Domain.Entities.ProfileSetting", "ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
