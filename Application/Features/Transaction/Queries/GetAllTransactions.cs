...
{
    public class GetAllTransactions : IRequest<IEnumerable<GetTransactionDto>>
    {
        private readonly IPaginationFilter _filter;
        public GetAllTransactions(IPaginationFilter filter)
        {
            _filter = filter;
        }
        public class GetAllTransactionsHandler : IRequestHandler<GetAllTransactions, IEnumerable<GetTransactionDto>>
        {
            ...
            public async Task<IEnumerable<GetTransactionDto>> Handle(GetAllTransactions query, CancellationToken cancellationToken)
            {
